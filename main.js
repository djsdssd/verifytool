    ...
    $(document).ready(function() {
      ...
      var execute = function() {
        try {
          ...
          var outputVal = method(val, option.val())
          output.val(outputVal);

          refresh(input.val(), outputVal)
      ...
      function refresh(inputVal, outputVal) {
        var clientHash = "931dde3d0d99db6c71a3bfdd6ece7c70cfb6e2a55814282c973c1875adbd807d"

        //cur
        var resultList = GetRoomOpenNumber(inputVal, clientHash)
        $("#cur_pos1").html(resultList[0])
        $("#cur_pos2").html(resultList[1])
        $("#cur_pos3").html(resultList[2])
        $("#cur_pos4").html(resultList[3])
        $("#cur_pos5").html(resultList[4])
        
        $("#cur_open_info").show()

        //prev
        var resultList = GetRoomOpenNumber(outputVal, clientHash)

        $("#prev_pos1").html(resultList[0])
        $("#prev_pos2").html(resultList[1])
        $("#prev_pos3").html(resultList[2])
        $("#prev_pos4").html(resultList[3])
        $("#prev_pos5").html(resultList[4])
